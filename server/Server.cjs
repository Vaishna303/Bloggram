...
// mongoose.connect('mongodb://127.0.0.1:27017/NewBloggram', { useNewUrlParser: true, useUnifiedTopology: true });

// //mongoose.connect(MONGODB_URI, { useNewUrlParser: true, useUnifiedTopology: true });
// //mongoose.connect('mongodb+srv://vaishna303:<vaishu%40303>@bloggramdb.vxrrh33.mongodb.net/users?retryWrites=true&w=majority&appName=bloggramDB')
// const db = mongoose.connection;
// db.on('connected', () => console.log('connected'));
// db.on('open', () => console.log('open'));
// db.on('disconnected', () => console.log('disconnected'));
