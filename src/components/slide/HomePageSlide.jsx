        ...
        <>
            <Swiper
                style={{
                    ...
                    '--swiper-pagination-color': '#f54291',
                }}
                speed={800}
                parallax={true}
            ...
            >
                ...
                <SwiperSlide className="text">
                    <div className="title" data-swiper-parallax="-300">
                        ...
                        <br></br>
                        "Your Space to Share Ideas and Stories with the World"
                    </div>
                    <div className="subtitle" data-swiper-parallax="-200">
                        - Voltaire
                    </div>
                    <div
                        className="subtitle flex gap-6 mt-5"
                        data-swiper-parallax="-100"
                    >
                        <Link
                            to="https://en.wikipedia.org/wiki/Blog"
                            target="_blank"
                ...
                <SwiperSlide className="text">
                    ...
                    <div className="subtitle" data-swiper-parallax="-200">
                        Upload | Share | Inspire
                    </div>
                    <div className="subtitle flex gap-6 mt-5"></div>
                </SwiperSlide>
            </Swiper>
        </>
    );
