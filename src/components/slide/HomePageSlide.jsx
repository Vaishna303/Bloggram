            ...
            >
                ...
                <SwiperSlide className="text">
                    ...
                    <div className="subtitle flex gap-6 mt-5" data-swiper-parallax="-100">
                        <a href='https://en.wikipedia.org/wiki/Blog' target="_blank" rel="noopener noreferrer" className="white font-medium border-[1px] duration-200 transition-all ease-in border-black-500  rounded-md text-slate-900 bg-white cursor-pointer px-2 py-2 text-[0.8rem] hover:bg-red-500  bg-transparent hover:text-slate-50 md:text-[1rem] ">
      Read More
    </a>
                    </div>
