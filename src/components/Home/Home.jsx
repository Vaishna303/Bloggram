    ...
    return (
        <div className="w-full min-h-screen">
            ...
            <div className="w-full flex items-center justify-between flex-col gap-5 text-2xl b">
                <h1 className="text-2xl font-bold pt-6 underline">About Us</h1>
                <p className="w-1/2 font-light pb-20">Your Blog is a space for  writers and thinkers to share their ideas with the  world.
