...
//   const filteredBloggs = blogs.filter(blog => {
//     const isSearchTextMatched =
//     blog.author.toLowerCase().includes(searchText.toLowerCase()) ||
//     blog.title.toLowerCase().includes(searchText.toLowerCase()) ||
//       blog.subtitle.toLowerCase().includes(searchText.toLowerCase()) ||
...
//           <div className="flex w-full justify-between bg-slate-500 rounded py-1">
//   {categories.map((tag, index) => (
//     <p key={index} onClick={() => setCategory(tag)} className="cursor-pointer">
//       {tag}
//     </p>
//   ))}
// </div>
//  {/* Category Selection */}
//  <div className="flex w-full justify-between bg-slate-500 rounded py-1 overflow-x-auto">
//           {categories.map((cat, index) => (
//             <p
//               key={index}
//               onClick={() => setCategory(cat)}
...
//             {/* <p className="author text-slate-300 h-7 ">Category : {blog.category}</p> */}
